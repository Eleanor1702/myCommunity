...
static const char qt_meta_stringdata_SignUp[] = {
    "SignUp\0"
};
...
const QMetaObjectExtraData SignUp::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SignUp::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SignUp,
      qt_meta_data_SignUp, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SignUp::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SignUp))
