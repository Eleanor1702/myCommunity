...
static const char qt_meta_stringdata_SignIn[] = {
    "SignIn\0"
};
...
const QMetaObjectExtraData SignIn::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SignIn::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SignIn,
      qt_meta_data_SignIn, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SignIn::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SignIn))
