#include "../lib/LocalHostConfig.h"

LocalHostConfig::LocalHostConfig(QWidget* parent) : QWidget(parent) {
...
void LocalHostConfig::setMainWindowDesign() {
...
void LocalHostConfig::setMainLayoutDesign() {
...
void LocalHostConfig::callHome() {
    emit configHomeCalled();
}

void LocalHostConfig::confirm() {
